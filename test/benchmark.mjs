...
async function runTest(payloadMb) {
  ...
  console.log(`Byteflow: ${bsChunks} chunks read in ${(bsEnd - bsStart).toFixed(2)}ms`);
  ...
  console.log(`Result: Byteflow is ~${diff}x faster than Web Streams for this payload.`);
}

async function runBenchmark() {
  console.log('--- Byteflow Benchmark ---');
